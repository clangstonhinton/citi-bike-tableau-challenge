...
See the below for examples of visualizations. You can view the actual Tableau workbook [here](https://public.tableau.com/app/profile/charlie.hinton/viz/citibiketableauchallenge/CitiBikeStory).
### Ridership Growth
